...
[!endif]
	...
	{
		TRACE0("Non è stato possibile creare la barra della finestra di dialogo.\n");
		return -1;		// impossibile creare
	}

	if (!m_wndReBar.Create(this) || !m_wndReBar.AddBar(&m_wndToolBar) || !m_wndReBar.AddBar(&m_wndDlgBar))
	{
		TRACE0("Non è stato possibile creare il controllo Rebar.\n");
		return -1;      // impossibile creare
	}
[!if CONTAINER || CONTAINER_SERVER]
...
[!if ADV_DOCKING_NAVIGATION]
	...
	{
		TRACE0("Non è stato possibile creare il riquadro di navigazione.\n");
		return -1;      // impossibile creare
	}
[!endif]
[!if ADV_DOCKING_CAPTION]
	...
	if (!CreateCaptionBar())
	{
		TRACE0("Non è stato possibile creare la barra del titolo.\n");
		return -1;      // impossibile creare
	}
[!endif]
[!if ADV_DOCKING_NAVIGATION]
