// PreviewHandler.h: dichiarazione del gestore di anteprima
...
protected:
	...
	{
		// creare qui il controllo di anteprima
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: la creazione del controllo di anteprima non è riuscita. Codice errore: %d\n", GetLastError());
			return E_FAIL;
		}
		return S_OK;
	}
